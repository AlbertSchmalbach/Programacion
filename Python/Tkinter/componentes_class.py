...
class ComponentesVentana(tk.Tk):
    ...
    def _crear_componentes_tab3(self, tabulador):
        ...
        def mostrar_valor():
            messagebox.showinfo(
                'Valor Seleccionado', f'El valor seleccionado es: {combobox.get()}')
    ...
    def _crear_componentes_tab4(self, tabulador):
        ...
        def mostrar_titulo():
            messagebox.showinfo(
                'Mas Info', f'Nombre Imagen: {imagen.cget("file")}')
        btn_imagen = ttk.Button(
            tabulador, image=imagen, command=mostrar_titulo)
    ...
    def _crear_componentes_tab5(self, tabulador):
        ...
        barra_progreso.grid(row=0, column=0, padx=10,
        ...
        boton_detener = ttk.Button(
            tabulador, text='Detener Ejecucion', command=detener)
...
if __name__ == '__main__':
    componentes = ComponentesVentana()
