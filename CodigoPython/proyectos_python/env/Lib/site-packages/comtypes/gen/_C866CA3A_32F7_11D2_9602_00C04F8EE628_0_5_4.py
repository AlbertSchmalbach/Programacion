...
__all__ = [
    'DISPID_SRGetFormat', 'SpeechGrammarWordType',
    'DISPID_SpeechRecognizerStatus', 'Speech_Max_Pron_Length',
    'SpeechGrammarTagWildcard', 'SASClosed', 'eLEXTYPE_PRIVATE12',
    'SPEI_SR_AUDIO_LEVEL', 'SP_VISEME_0', 'DISPID_SOTGetDescription',
    'DISPID_SPRsCount', 'ISpeechPhraseElement', 'SP_VISEME_8',
    'SPRULE', 'SFTInput', 'DISPID_SPIGetText',
    'DISPID_SpeechGrammarRuleState', 'SAFT24kHz8BitMono',
    'DISPID_SPPName', 'DISPID_SVEVoiceChange', 'SVF_Stressed',
    'SpeechRecoEvents', 'SpSharedRecognizer',
    'DISPID_SDKGetStringValue', 'DISPID_SPRuleChildren',
    'DISPID_SVSLastBookmark', 'DISPID_SRCEStartStream', 'SPPHRASE',
    'DISPID_SRRRecoContext', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechBaseStream', 'SPEI_HYPOTHESIS',
    'SDA_Two_Trailing_Spaces', 'SPSHT_NotOverriden', 'SPWORDTYPE',
    ...
    'SAFTADPCM_8kHzMono', 'SpeechLexiconType', 'ISpStream',
    'DISPID_SRCState', 'eLEXTYPE_PRIVATE9', 'SVP_3', 'SVF_Emphasis',
    'SpeechPartOfSpeech', 'SpeechEmulationCompareFlags',
    'SP_VISEME_6', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SVSVisemeId', 'STSF_LocalAppData', 'SpCustomStream',
    'eLEXTYPE_PRIVATE3', 'SPEI_WORD_BOUNDARY',
    'ISpObjectTokenCategory', 'SINone', 'DISPID_SPISaveToMemory',
    'DISPID_SRRPhraseInfo', 'SPAR_Unknown', 'DISPID_SGRSTType',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVGetAudioInputs',
    'DISPID_SRRGetXMLResult', 'SRTStandard', 'SVSFNLPSpeakPunc',
    'SAFT22kHz8BitStereo', 'DISPID_SPRulesItem',
    'DISPID_SDKGetBinaryValue', 'DISPID_SREmulateRecognition',
    'ISpeechBaseStream', 'SECFIgnoreWidth', 'SDA_One_Trailing_Space',
    ...
    'SAFT16kHz16BitStereo', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SVSRunningState', 'DISPID_SASetState', 'DISPID_SPEsCount',
    'SPAO_RETAIN_AUDIO', 'SPXRO_Alternates_SML', 'DISPID_SRCPause',
    'DISPID_SVEventInterests', 'DISPID_SASNonBlockingIO',
    'DISPID_SPRulesCount', 'SpeechRuleState', 'ISpRecoGrammar',
    'SPSVerb', 'SpeechVoiceEvents', 'ISpEventSink',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPPs_NewEnum', 'SAFTNoAssignedFormat',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SFSOpen', 'SGSDisabled',
    'SAFT8kHz16BitStereo', 'SPCT_SLEEP', 'SPDKL_DefaultLocation',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SVSLastResult',
    'DISPID_SpeechPhraseInfo', 'DISPID_SDKEnumKeys',
    'DISPID_SPRules_NewEnum', 'DISPID_SRGId', 'SpSharedRecoContext',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SDKOpenKey',
    'SPXRO_SML', 'SpeechInterference',
    'DISPID_SOTRemoveStorageFileName', 'SPRST_ACTIVE_ALWAYS',
    'eLEXTYPE_RESERVED7', 'SPEI_MIN_TTS', 'DISPID_SRCEPhraseStart',
    'SPEI_MAX_TTS', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SMSSetData', 'DISPID_SPRsItem', 'SPSModifier',
    'SpAudioFormat', 'DISPID_SGRInitialState',
    ...
    'SPPS_SuppressWord', 'SpPhoneConverter', 'DISPID_SOTCId',
    'SPAO_NONE', 'SPEI_MIN_SR', 'SVP_16', 'SPEI_RESERVED2',
    'SSSPTRelativeToEnd', 'DISPID_SPCIdToPhone',
    'SpeechEngineConfidence', 'ISpNotifyTranslator', 'SPAR_Low',
    'STCLocalServer', 'SpeechAllElements', 'SVP_6',
    'ISpeechObjectTokenCategory', 'DISPID_SRCBookmark',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpeechLexiconPronunciations',
    'SpeechTokenKeyFiles', 'ISpeechPhraseProperties',
    'SPCATEGORYTYPE', 'SpInProcRecoContext',
    'DISPID_SGRSAddRuleTransition', '_SPAUDIOSTATE', 'SPRST_INACTIVE',
    'SAFT24kHz8BitStereo', 'SpeechCategoryAppLexicons',
    'SAFTADPCM_11kHzStereo', 'SpNullPhoneConverter', 'ISpProperties',
    'tagSTATSTG', 'eLEXTYPE_PRIVATE19', 'DISPID_SPARecoResult',
    'SPSTREAMFORMATTYPE', 'SPEI_PHONEME', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRCVoice', 'SPLO_STATIC', 'DISPID_SVSpeakStream',
    'DISPID_SWFESamplesPerSec', 'ISpSerializeState',
    'DISPID_SOTs_NewEnum', 'DISPID_SPACommit', 'DISPID_SPPChildren',
    'SGLexicalNoSpecialChars', 'ISpeechPhoneConverter', 'SGDisplay',
    'SDTAlternates', 'SVP_4',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPARTOFSPEECH',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SVEPhoneme',
    'SPLO_DYNAMIC', 'DISPID_SOTIsUISupported', 'SPGRAMMARWORDTYPE',
    'DISPID_SGRSAddWordTransition', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPRuleId', 'SPEI_RESERVED1', 'SDKLLocalMachine',
    'ISpPhraseAlt', 'SVP_7', 'SDTRule', 'SVSFUnusedFlags',
    'SPINTERFERENCE_NOISE', 'SVEStartInputStream',
    'SpeechPropertyHighConfidenceThreshold', 'eWORDTYPE_DELETED',
    'SGPronounciation', 'SAFTTrueSpeech_8kHz1BitMono', 'SPEI_MAX_SR',
    'SGLexical', 'SPAUDIOBUFFERINFO', 'SPEI_TTS_PRIVATE',
    'SECFDefault', 'SPVPRI_ALERT', 'DISPID_SPERetainedStreamOffset',
    'SGDSActiveUserDelimited', 'SPFM_OPEN_READWRITE', 'SP_VISEME_9',
    'SpeechGrammarState', 'SAFTCCITT_uLaw_22kHzStereo', 'SLOStatic',
    'DISPID_SGRName', 'DISPID_SRCEAdaptation',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRCRetainedAudio',
    'DISPID_SLWs_NewEnum', 'SPPS_Noncontent',
    'ISpeechRecoResultTimes', 'SAFT44kHz16BitStereo',
    'SAFT8kHz8BitStereo', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRCERecognition',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpStreamFormatConverter', 'SAFT44kHz16BitMono',
    'DISPID_SRCCreateGrammar', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'ISpeechAudioFormat', 'DISPID_SRGIsPronounceable',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SBSSeek',
    'SVSFPurgeBeforeSpeak', 'DISPID_SVEEnginePrivate',
    'SPCS_DISABLED', 'SPFM_CREATE_ALWAYS', 'SAFTCCITT_uLaw_22kHzMono',
    'SREFalseRecognition', 'SRAImport', 'SRAInterpreter',
    'SPSERIALIZEDPHRASE', 'SPBO_AHEAD', 'DISPID_SVVolume',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SVSLastBookmarkId',
    'DISPID_SVAudioOutput', 'SGSExclusive',
    ...
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechObjectTokens', 'SpUnCompressedLexicon', 'SLTUser',
    'eLEXTYPE_RESERVED10', 'SpStream', 'SAFT32kHz16BitStereo',
    'SAFTADPCM_11kHzMono', 'SPLEXICONTYPE', 'ISpObjectWithToken',
    'SpFileStream', 'SRCS_Enabled', 'SPPS_RESERVED2',
    ...
    'DISPID_SpeechPhraseRules', 'SVEViseme', 'DISPID_SVVoice',
    'DISPID_SPRFirstElement', 'DISPIDSPTSI_SelectionOffset',
    'SPSHT_Unknown', 'SAFT11kHz8BitStereo', 'SAFT44kHz8BitStereo',
    'DISPID_SPPEngineConfidence', 'DISPID_SRSetPropertyString',
    'SVP_17', 'SpeechVisemeType', 'DISPID_SpeechRecoResult',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPIRetainedSizeBytes',
    'SPEI_RECOGNITION', 'SAFTADPCM_44kHzMono', 'SPRST_ACTIVE',
    'eLEXTYPE_PRIVATE18', 'SPPS_RESERVED1', 'Speech_Max_Word_Length',
    'SGRSTTDictation', 'DISPID_SVSpeakCompleteEvent', 'SPWT_LEXICAL',
    'SVSFVoiceMask', 'DISPID_SpeechPhraseElements',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SASState', 'SVEWordBoundary',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPPS_Function',
    'DISPID_SOTRemove', 'DISPID_SpeechPhoneConverter',
    'DISPID_SLAddPronunciation', 'SREStateChange', 'SRADynamic',
    'SpeechCategoryVoices', 'SVEPrivate', 'DISPID_SGRsFindRule',
    'SPDKL_CurrentUser', 'SGRSTTWord', 'SpPhraseInfoBuilder',
    'ISpNotifySink', 'SPEI_PHRASE_START', 'SPEI_SR_BOOKMARK',
    'SpeechWordPronounceable', 'DISPID_SpeechDataKey',
    'DISPID_SRRSaveToMemory', 'SASPause', 'SPFILEMODE', 'SAFTDefault',
    'SPRS_INACTIVE', 'SpeechTokenValueCLSID',
    'SGDSActiveWithAutoPause', 'SPAUDIOSTATUS', 'SGSEnabled',
    'SSFMCreate', 'SAFT11kHz8BitMono', 'SAFT22kHz16BitStereo',
    'DISPID_SpeechAudioStatus', 'SPEI_RESERVED6', 'SVSFIsNotXML',
    'DISPID_SDKSetLongValue', 'SP_VISEME_20', 'SPPS_LMA',
    'DISPID_SPERetainedSizeBytes', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVEWord', 'DISPID_SRCERecognitionForOtherContext',
    'SAFTGSM610_22kHzMono', 'SPSNotOverriden',
    'DISPID_SPEActualConfidence', 'SVEBookmark', 'SVP_19',
    'ISpXMLRecoResult', 'ISpeechMMSysAudio', 'STCInprocServer',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'eLEXTYPE_PRIVATE14',
    'SDA_Consume_Leading_Spaces', 'ISpeechLexiconPronunciation',
    'SREStreamEnd', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SREPropertyNumChange', 'ISpVoice', 'SRERecognition',
    '_ISpeechVoiceEvents', '_ISpeechRecoContextEvents',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SpeechGrammarRule', 'SVP_5',
    'SpeechAudioFormatType', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRCSetAdaptationData', 'SASRun', 'SVPAlert',
    'DISPID_SRRecognizer', 'SPEI_UNDEFINED', 'SPPS_NotOverriden',
    'SPDKL_LocalMachine', 'SPEI_START_INPUT_STREAM',
    'eLEXTYPE_PRIVATE4', 'ISpeechObjectTokens', 'SpeechVoicePriority',
    'SPBOOKMARKOPTIONS', 'SPAS_STOP', 'ISequentialStream',
    'DISPID_SOTDataKey', 'SpeechCategoryRecognizers',
    'eLEXTYPE_MORPHOLOGY', 'SPEI_RESERVED5', 'SP_VISEME_13',
    'SPEVENTENUM', 'SVP_15', 'SAFTNonStandardFormat', 'SGDSInactive',
    'DISPID_SPIProperties', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpeechPhraseElements', 'SpeechEngineProperties', 'SPPS_Verb',
    'DISPID_SPRuleConfidence', 'DISPID_SVPriority', 'SVSFParseMask',
    ...
    'SPSHT_EMAIL', 'DISPID_SpeechMemoryStream',
    'DISPID_SpeechPhraseReplacement', 'SSFMOpenForRead',
    'SpeechDataKeyLocation', 'SPWORDPRONOUNCEABLE', 'IStream',
    'DISPID_SPERequiredConfidence', 'SpLexicon', 'SECFNoSpecialChars',
    'SVSFParseSapi', 'eLEXTYPE_PRIVATE20', 'SAFTCCITT_ALaw_8kHzMono',
    '_RemotableHandle', 'SP_VISEME_11', 'ISpeechRecognizerStatus',
    'SAFT48kHz16BitMono', 'SPAUDIOSTATE', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRAudioInputStream', 'SpeechRecoContextState',
    'SpeechAudioVolume', 'DISPID_SPPsItem',
    'SAFTCCITT_ALaw_11kHzMono', 'SASStop', 'DISPID_SPIGrammarId',
    'DISPID_SPAsItem', 'SAFTCCITT_uLaw_44kHzStereo', 'SRERequestUI',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPEPronunciation',
    'DISPID_SGRsCommitAndSave', 'SAFT8kHz8BitMono',
    'DISPID_SPIReplacements', 'DISPID_SGRId', 'ISpeechLexiconWords',
    'SPPS_RESERVED4', 'SPEI_INTERFERENCE', 'DISPID_SGRSTNextState',
    'SAFT32kHz16BitMono', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SABIBufferSize', 'DISPID_SLPPartOfSpeech',
    'DISPID_SPIRule', 'SpeechVisemeFeature', 'SAFT12kHz8BitMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpeechRecoProfileProperties',
    'DISPID_SRCRecognizer', 'SP_VISEME_15', 'ISpDataKey',
    'SPINTERFERENCE_NONE', 'DISPID_SRSSupportedLanguages',
    'SPEI_VISEME', 'ISpeechPhraseRule', 'DISPID_SDKSetBinaryValue',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SVGetAudioOutputs',
    'DISPID_SOTsItem', 'SECHighConfidence', 'eLEXTYPE_PRIVATE1',
    'SPCT_DICTATION', 'SpMMAudioEnum', 'DISPID_SLGetWords',
    'SAFT32kHz8BitMono', 'DISPID_SABufferInfo',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SPPFirstElement',
    'DISPID_SVSPhonemeId',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPFM_OPEN_READONLY', 'SREInterference', 'SDKLCurrentConfig',
    'DISPID_SRRSpeakAudio', 'DISPID_SRAudioInput', 'SGRSTTTextBuffer',
    'SRSInactive', 'SpeechLoadOption', 'DISPID_SGRAddResource',
    'SP_VISEME_7', 'DISPID_SPAs_NewEnum',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPPConfidence',
    'ISpeechRecoGrammar', 'DISPID_SPRuleFirstElement',
    'SAFTGSM610_8kHzMono', 'SPWAVEFORMATTYPE', 'SVP_11',
    'ISpMMSysAudio', 'DISPID_SRGDictationSetState',
    'DISPID_SPEs_NewEnum', 'SVP_2', 'SVPOver', 'SP_VISEME_5',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRProfile', 'SPPS_Noun',
    'SPWORDPRONUNCIATIONLIST', 'SpeechVoiceSpeakFlags',
    'DISPID_SRSetPropertyNumber', 'eLEXTYPE_RESERVED9',
    'DISPID_SOTGetAttribute', 'SRAONone', 'SPAS_CLOSED',
    'eLEXTYPE_PRIVATE17', 'SpStreamFormatConverter',
    'SpeechFormatType', 'DISPID_SOTGetStorageFileName',
    'SECFIgnoreKanaType', 'DISPID_SRRTLength',
    'ISpeechPhraseAlternate', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SDKCreateKey', 'SAFT16kHz8BitMono',
    'SpeechGrammarRuleStateTransitionType',
    'ISpeechGrammarRuleStateTransition', 'SpMemoryStream',
    'DISPID_SVSkip', 'SpeechStreamFileMode', 'SVP_0',
    'SPEVENTSOURCEINFO', 'DISPID_SOTMatchesAttributes',
    ...
    'SRSActiveAlways', 'ISpRecoContext2', 'DISPID_SGRSTRule',
    'SPCT_COMMAND', 'ISpRecoCategory', 'SVEVoiceChange',
    'SVSFParseAutodetect', 'SP_VISEME_14', 'SpInprocRecognizer',
    'SPWF_SRENGINE', 'SPLOADOPTIONS', 'DISPID_SRGCmdSetRuleState',
    'SVSFIsFilename', 'SpObjectTokenCategory',
    'SAFTCCITT_ALaw_22kHzMono', 'SPSEMANTICFORMAT',
    'ISpeechGrammarRules', 'SAFTText', 'SRTReSent',
    'DISPID_SGRSTsItem', 'DISPID_SRGDictationLoad',
    'SAFTADPCM_44kHzStereo', 'SAFT24kHz16BitStereo',
    'SpeechPropertyAdaptationOn', 'DISPID_SPRuleName', 'SP_VISEME_19',
    'DISPID_SRRAudioFormat', 'SAFT11kHz16BitMono',
    'DISPID_SRCEEndStream', 'SPVISEMES', 'eLEXTYPE_RESERVED4',
    'DISPID_SLPs_NewEnum', 'DISPID_SWFEChannels',
    'DISPID_SPPBRestorePhraseFromMemory',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPSHORTCUTPAIRLIST',
    'SRATopLevel', 'ISpeechWaveFormatEx',
    'DISPID_SRCCmdMaxAlternates', 'SPCT_SUB_COMMAND',
    'SPBO_TIME_UNITS', 'DISPID_SGRAttributes', 'ISpeechPhraseInfo',
    ...
    'DISPID_SGRsCommit', 'DISPID_SVSInputWordLength', 'SPSUnknown',
    'ISpeechVoiceStatus', 'SREStreamStart',
    'DISPID_SpeechLexiconWord', 'SPVPRIORITY', 'SVSFlagsAsync',
    'SREHypothesis', 'SRADefaultToActive', 'SpeechTokenKeyAttributes',
    'DISPID_SRState', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SVSFNLPMask',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPIAudioSizeTime', 'DISPID_SOTCGetDataKey',
    'SSFMCreateForWrite', 'SWTAdded', 'ISpeechRecognizer',
    'DISPID_SRCEPropertyStringChange', 'SpeechDictationTopicSpelling',
    'DISPID_SpeechRecoResultTimes', 'STSF_AppData', 'STSF_FlagCreate',
    'SPAR_Medium', 'DISPID_SRRTOffsetFromStart',
    'SpeechAudioFormatGUIDWave', 'ISpeechPhraseRules',
    'DISPID_SVSInputSentenceLength', 'SPAUDIOOPTIONS', 'SITooLoud',
    'ISpPhoneticAlphabetConverter', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SGRsAdd', 'DISPID_SVEViseme', 'SDKLCurrentUser',
    'DISPID_SPIAudioStreamPosition', 'SAFT24kHz16BitMono',
    'DISPID_SRIsShared', 'eLEXTYPE_PRIVATE6', 'ISpRecognizer',
    'DISPID_SVEBookmark', 'SpeechGrammarTagDictation',
    'SAFT12kHz8BitStereo', 'SPINTERFERENCE_TOOSLOW',
    'SAFT22kHz16BitMono', 'Speech_StreamPos_RealTime',
    'DISPID_SGRSRule', 'SPGS_DISABLED', 'SPPHRASEREPLACEMENT',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRCEHypothesis',
    'DISPID_SLWType', 'DISPID_SAStatus', 'SpObjectToken',
    'DISPID_SpeechCustomStream', 'DISPID_SLPPhoneIds',
    'DISPID_SRGState', 'eLEXTYPE_PRIVATE13', 'SLTApp',
    'SpeechRegistryUserRoot', 'SPAS_RUN', 'SP_VISEME_18',
    'DISPID_SVDisplayUI', 'DISPID_SGRSTPropertyName',
    'DISPID_SRDisplayUI', 'ISpeechXMLRecoResult',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRGSetWordSequenceData',
    'SPPHRASEELEMENT', 'eLEXTYPE_USER', 'SPEI_START_SR_STREAM',
    'SVEAudioLevel', 'SPEI_END_INPUT_STREAM', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SGRs_NewEnum',
    'DISPID_SLPSymbolic', 'ISpObjectToken',
    'DISPID_SpeechRecoResult2', 'DISPID_SpeechPhraseRule', 'SVP_20',
    'SVSFDefault', 'DISPID_SRCESoundStart', 'DISPID_SPAsCount',
    'SREBookmark', 'SITooFast', 'ISpeechFileStream',
    'DISPID_SRRTTickCount', 'SPCS_ENABLED', 'SP_VISEME_4',
    'SP_VISEME_12', 'DISPID_SVSLastStreamNumberQueued',
    'ISpeechRecoResultDispatch', 'SPRECORESULTTIMES',
    'SPSEMANTICERRORINFO', 'IInternetSecurityMgrSite',
    'SRAORetainAudio', 'SRAExport', 'SPBO_NONE',
    'DISPID_SRGetRecognizers', 'SAFT32kHz8BitStereo', 'SPSMF_UPS',
    'DISPID_SRCResume', 'ISpPhrase', 'SVP_9',
    'DISPID_SpeechLexiconProns', 'SAFTExtendedAudioFormat',
    'SpeechPropertyLowConfidenceThreshold', 'SREAudioLevel',
    'DISPID_SLPsItem', 'SpeechAddRemoveWord', 'DISPID_SOTDisplayUI',
    'DISPID_SGRAddState', 'SVEAllEvents', 'SPEI_REQUEST_UI',
    'SRESoundStart', 'SLODynamic', 'SPSInterjection', 'SSTTDictation',
    'SpeechCategoryRecoProfiles', 'ISpPhoneConverter',
    'SRSInactiveWithPurge', 'SpeechCategoryAudioOut',
    'SAFT8kHz16BitMono', 'SRSActive', 'DISPID_SWFEFormatTag',
    'SWTDeleted', 'SPEI_SR_PRIVATE', 'SpeechDiscardType',
    'DISPID_SMSALineId', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRRSetTextFeedback', 'DISPID_SVIsUISupported',
    'DISPID_SPCPhoneToId', 'STSF_CommonAppData',
    'DISPID_SpeechObjectToken', 'DISPID_SPELexicalForm',
    'ISpPhoneticAlphabetSelection', 'ISpeechMemoryStream', 'SVP_14',
    'DISPID_SASCurrentSeekPosition', 'SPVPRI_OVER', 'DISPID_SRRTimes',
    'UINT_PTR', 'DISPID_SpeechVoice', 'SPINTERFERENCE_TOOFAST',
    'SVP_18', 'DISPID_SRGReset', 'DISPID_SpeechAudio',
    'SDTLexicalForm', 'DISPID_SPIElements', 'ISpShortcut',
    'ISpEventSource', 'ISpeechTextSelectionInformation',
    ...
    'eLEXTYPE_RESERVED8', 'SAFTADPCM_22kHzStereo', 'DISPID_SVPause',
    'DISPID_SABIEventBias', 'DISPID_SVEStreamStart',
    'DISPID_SRCreateRecoContext', 'DISPID_SpeechPhraseReplacements',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SRRAlternates',
    'SpeechSpecialTransitionType', 'SSSPTRelativeToStart',
    'WAVEFORMATEX', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SpeechGrammarRules', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SGRSTText', 'DISPID_SWFEExtraData', 'SpeechTokenContext',
    'DISPID_SLPLangId', 'DISPID_SVStatus', 'IEnumString',
    'DISPID_SRCEventInterests', 'ISpeechGrammarRuleState',
    'SDKLDefaultLocation', 'SECFIgnoreCase',
    'DISPID_SPRDisplayAttributes', 'tagSPPROPERTYINFO', 'SRARoot',
    'DISPID_SWFEBitsPerSample', 'IEnumSpObjectTokens',
    'SPBINARYGRAMMAR', 'ISpeechRecoResult',
    'ISpeechPhraseReplacements', 'SpeechAudioState', 'SINoise',
    'SP_VISEME_21', 'DISPID_SRCRequestedUIType',
    'SAFT16kHz8BitStereo', 'SECNormalConfidence',
    'ISpeechAudioBufferInfo', 'SPRS_ACTIVE', 'SpeechAudioProperties',
    'DISPID_SOTCSetId', 'DISPID_SRGDictationUnload',
    'DISPID_SMSGetData', 'SPVOICESTATUS', 'LONG_PTR', 'SPWORDLIST',
    'DISPID_SRGSetTextSelection', 'DISPID_SRGCmdLoadFromMemory',
    'SAFTGSM610_44kHzMono', 'DISPID_SpeechPhraseBuilder',
    'SPWT_PRONUNCIATION', 'SECLowConfidence', 'DISPID_SVRate',
    'SINoSignal', 'SP_VISEME_3', 'DISPID_SPAPhraseInfo',
    'DISPID_SOTCDefault', 'DISPID_SRCEInterference',
    'SpeechPropertyComplexResponseSpeed', 'eLEXTYPE_APP',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpeechPhraseInfoBuilder', 'SPSNoun',
    'ISpeechRecoResult2', 'SGRSTTEpsilon',
    'DISPID_SOTCEnumerateTokens', 'SP_VISEME_17', 'SPSHORTCUTTYPE',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SOTId',
    'ISpeechPhraseAlternates', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPRs_NewEnum', 'DISPID_SLWWord', 'DISPID_SGRsItem',
    ...
    'SDA_No_Trailing_Space', 'SPSHORTCUTPAIR', 'DISPID_SAVolume',
    'SpMMAudioOut', 'ISpeechVoice', 'SVEEndInputStream',
    'SREPropertyStringChange', 'SP_VISEME_16',
    'DISPID_SPIEnginePrivateData', 'SREAdaptation', 'SPFM_NUM_MODES',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpRecoContext', 'DISPID_SPEsItem', 'DISPID_SpeechAudioFormat',
    'DISPID_SPIStartTime', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SVAlertBoundary', 'DISPID_SPEAudioStreamOffset', 'STCAll',
    'DISPID_SRCEAudioLevel', 'SDTPronunciation',
    'DISPID_SpeechPhraseElement', 'SVF_None',
    'DISPID_SPIAudioSizeBytes', 'ISpRecoGrammar2',
    'SpeechBookmarkOptions', 'ISpeechAudio', 'DISPID_SLPType',
    'SDTAll', 'SAFTADPCM_22kHzMono', 'SPEI_RESERVED3',
    'SVESentenceBoundary', 'SRTSMLTimeout', 'DISPID_SLWLangId',
    'SpeechTokenKeyUI', 'ISpLexicon', 'ISpRecoResult',
    'Speech_StreamPos_Asap', 'DISPID_SGRSTransitions',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPIDSPRG',
    'DISPID_SMSAMMHandle', 'SREPhraseStart', 'SPSSuppressWord',
    'SPCONTEXTSTATE', 'ISpStreamFormat',
    'SWPUnknownWordPronounceable', 'ISpeechResourceLoader',
    'DISPID_SpeechWaveFormatEx', 'SPEI_RECO_STATE_CHANGE', 'SPSLMA',
    'ISpeechPhraseReplacement', 'SPVPRI_NORMAL',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRSNumberOfActiveRules',
    'SVPNormal', 'SPEI_SR_RETAINEDAUDIO', 'SpeechTokenShellFolder',
    'DISPID_SRCERequestUI', 'DISPID_SVEAudioLevel', 'SPWT_DISPLAY',
    'DISPID_SGRClear', 'DISPID_SGRSTsCount',
    'SAFTCCITT_ALaw_22kHzStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'SPRST_NUM_STATES', 'DISPID_SPIEngineId', 'SAFT48kHz8BitMono',
    'STCRemoteServer', 'DISPID_SLPsCount', 'SpShortcut',
    'SpeechRuleAttributes', 'DISPID_SRCEEnginePrivate',
    'SPGRAMMARSTATE', 'SVP_13', 'SRESoundEnd',
    'DISPID_SpeechLexiconWords', 'DISPID_SOTSetId',
    '__MIDL_IWinTypes_0009', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SRCEFalseRecognition', 'SAFT12kHz16BitMono',
    'DISPID_SPEEngineConfidence', 'DISPID_SVSpeak', 'SVP_1',
    'SPPS_Unknown', 'SPSERIALIZEDRESULT', 'SP_VISEME_1',
    'eLEXTYPE_VENDORLEXICON', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpTextSelectionInformation', 'DISPID_SGRsDynamic',
    'DISPID_SGRsCount', 'SRTAutopause', 'SPCT_SUB_DICTATION',
    'ISpeechLexiconWord', 'SVP_21', 'eLEXTYPE_PRIVATE8',
    'DISPID_SBSRead', 'SPRECOSTATE', 'DISPID_SVGetVoices',
    'DISPID_SpeechXMLRecoResult', 'SpeechCategoryAudioIn',
    'DISPID_SADefaultFormat', 'SGRSTTRule', 'SpeechDisplayAttributes',
    'DISPID_SDKDeleteValue', 'DISPID_SFSClose',
    'DISPID_SPEDisplayText', 'DISPID_SRGetPropertyNumber',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SLWPronunciations',
    'SpeechStreamSeekPositionType', 'DISPID_SBSFormat',
    'DISPID_SGRSTWeight', 'SPRULESTATE', 'DISPID_SDKSetStringValue',
    'SPTEXTSELECTIONINFO', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRRAudio',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SPPId', 'ISpeechObjectToken',
    'DISPID_SpeechRecognizer', 'SGDSActive', 'DISPIDSPTSI',
    'SREAllEvents', 'SpeechRecognitionType', 'DISPID_SAFType',
    'SSFMOpenReadWrite', 'SPPS_RESERVED3', 'SpVoice',
    'ISpeechAudioStatus', 'DISPID_SOTsCount', 'SPPHRASERULE',
    'DISPID_SPRuleParent', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SLWsItem', 'DISPID_SPRNumberOfElements',
    'SRERecoOtherContext', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SAFGuid', 'DISPID_SRGCmdSetRuleIdState', 'SVP_12',
    'SPWORD', 'SPPS_Modifier', 'SPGS_EXCLUSIVE',
    'DISPID_SRCAudioInInterferenceStatus', 'SVEPhoneme',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPBO_PAUSE',
    'DISPID_SRCERecognizerStateChange', 'SPEI_END_SR_STREAM',
    'SPWF_INPUT', 'DISPID_SRRTStreamTime', 'SpWaveFormatEx',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SDKDeleteKey',
    'DISPID_SWFEBlockAlign', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SpeechLexicon', 'SAFT48kHz16BitStereo',
    'DISPID_SCSBaseStream', 'DISPID_SRRGetXMLErrorInfo',
    'SPSHT_OTHER', 'SECFEmulateResult', 'SVSFIsXML',
    'SPWORDPRONUNCIATION', 'eLEXTYPE_PRIVATE15', 'DISPID_SVResume',
    'SPEI_SOUND_END', 'SRCS_Disabled', 'SVSFParseSsml',
    'SVSFPersistXML', 'DISPID_SRGRules', 'SITooQuiet',
    'ISpeechRecoContext', 'DISPID_SAEventHandle', 'ISpeechLexicon',
    'DISPID_SLGetPronunciations', 'SpeechRetainedAudioOptions',
    'SPDKL_CurrentConfig', 'SPAR_High', 'SSTTTextBuffer',
    'DISPID_SABufferNotifySize',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechCustomStream',
    'ISpRecognizer3', 'SPADAPTATIONRELEVANCE', 'SPPS_Interjection',
    'SpeechAudioFormatGUIDText', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPAStartElementInResult', 'SBONone', 'SVP_8',
    'SPSFunction', 'DISPID_SRGCommit', 'SP_VISEME_2',
    'DISPID_SRStatus', 'SSTTWildcard', 'DISPID_SPPParent',
    'SpMMAudioIn', 'SDTProperty', 'SPEVENT', 'SDTDisplayText',
    'SPPROPERTYINFO', 'ISpeechDataKey', 'eLEXTYPE_PRIVATE7',
    'DISPID_SpeechFileStream', 'SAFT16kHz16BitMono',
    'SpeechUserTraining', 'DISPID_SVSInputWordPosition',
    'DISPID_SPPsCount', 'DISPID_SpeechMMSysAudio', 'SFTSREngine',
    'ISpNotifySource', 'DISPID_SVGetProfiles', 'SpCompressedLexicon',
    'DISPID_SLGenerationId', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SDKEnumValues', 'SDTAudio', 'SRSEDone', 'SRTEmulated',
    'SREPrivate', 'SDTReplacement', 'SPINTERFERENCE',
    'SRSEIsSpeaking', 'DISPID_SVEStreamEnd', 'DISPID_SRGRecoContext',
    'ISpAudio', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPRText', 'SPAS_PAUSE',
    'SPPHRASEPROPERTY', 'SBOPause', 'DISPID_SVSCurrentStreamNumber',
    'SpeechRecognizerState', 'SPRECOCONTEXTSTATUS',
    'SpeechMicTraining', 'DISPID_SPCLangId', 'DISPID_SDKGetlongValue',
    'Speech_Default_Weight', 'SpPhoneticAlphabetConverter', 'SVP_10',
    'DISPID_SRCESoundEnd', 'SpResourceManager', 'eWORDTYPE_ADDED',
    'ISpeechGrammarRule', 'eLEXTYPE_PRIVATE11', 'STCInprocHandler',
    'SpeechRegistryLocalMachineRoot', 'SPEI_PROPERTY_STRING_CHANGE',
    'SITooSlow', 'SPXMLRESULTOPTIONS', 'DISPID_SVWaitUntilDone',
    'SWPKnownWordPronounceable', 'SPEI_VOICE_CHANGE',
    'SGRSTTWildcard', 'SAFT48kHz8BitStereo', 'SPEI_SOUND_START',
    'SAFT12kHz16BitStereo', 'ISpeechPhraseProperty', 'SPFM_CREATE'
]

_check_version('1.2.0', 1700159907.405517)
