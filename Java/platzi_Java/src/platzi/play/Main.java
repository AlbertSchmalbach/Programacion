...
public class Main {
        ...
        while (true) {
            ...
            switch (opcionElegida) {
                case AGREGAR -> {
                    ...
                    Pelicula peli1 = new Pelicula(nombre, duracion, genero, calificacion);
                ...
                case ELIMINAR -> {
                    ...
                    if (pelicula != null){
                        ...
                        System.out.println("❌ Pelicula " + nombreEliminar + " eliminada de la plataforma.");
                    } else {
                        System.out.println(nombreEliminar + " no existe dentro de " + plataforma.getNombre());
                    }
    ...
    private static  void cargarPeliculas(Plataforma plataforma) {
        ...
        plataforma.agregar(new Pelicula("Titanic", 145, "Drama", 4.6));
        plataforma.agregar(new Pelicula("Jonh Wick", 101, "Accion"));
        plataforma.agregar(new Pelicula("El Conjuro", 112, "Terror", 3.0));
        plataforma.agregar(new Pelicula("Coco", 105, "Animada", 4.7));
        plataforma.agregar(new Pelicula("Intelestelar", 169, "Ciencia Ficcion", 5.0));
        plataforma.agregar(new Pelicula("Joker", 122, "Drama"));
        plataforma.agregar(new Pelicula("Toy Store", 81, "Animada", 4.2));
        plataforma.agregar(new Pelicula("Avenger: Endgame", 181, "Accion", 4.9));
    }
}
